...
```{r cflh, echo=FALSE, fig.cap='Smooth coneflower, *Echinecea laevigata*, is an endangered plant that lives in only a few places on poor soils. It prefers sunny open habitats, long walks in the rain, and reading a good book by the fire.', out.width='100%', fig.show='hold'}
