...
## Exploring the stability of bipartite networks
...
To use `bip_stability`, you will need to install a couple more packages. If you've already installed them, you have nothing to do.
```{r}
# pkgs <- c("bipartite","igraph", "rARPACK")
