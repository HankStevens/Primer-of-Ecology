...
metabolic rate with increasing temperature (Fig. @fig-arrh).
...
abundances, we get the \*species abundance distribution (Fig. @fig-mete1b). @preston1962cdc noted that the distributions were remarkabling similar to a normal
