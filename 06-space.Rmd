...
```{r CandG, echo=FALSE, fig.cap="A frequency distribution of the number of plant species (y-axis) that occupy different numbers of  grassland remnants (x-axis). This U-shaped (bimodal) distribution of the number of sites occupied is common, and is consistent with Hanski's model of the rescue effect. Other years were similar (Collins and Glenn 1991).", out.width="75%"}
...
* subpopulations of passerine birds that inhabit low quality forest patches in part because of immigration from high quality forest patches [@robinson1995; @donovan1995], and
* understory palms that inhabit distinct microhabitats in which seeds move from high to low quality patches [@berry2008].
```{r ssmodel, echo=FALSE, fig.cap="The simplest source-sink model, where $m_{21} > m_{12}$ so that net movement of individuals is from the source to the sink.", fig.width=10, fig.height=5, out.width="75%"}
...
```{r levins, fig.cap="The Levins metapopulation model (Levins 1969).", out.width="75%"}
...
```{r gotelli, fig.cap="*Propagule rain metapopulation model (a.k.a. island-mainland model).*", out.width="75%"}
...
```{r hanski, fig.cap="The core-satellite metapopulation model, with the rescue effect.", out.width="75%"}
