...
In this chapter, we introduce a perspective on ecological theory in particular, and provide an example of an efficient theory, metabolic scaling. 
...
Let mass $m_2$ be greater than mass $m_$ by a factor of $c$, so that $m_2 = c m_1$, and
$$\frac{m_2}{m_1} = c$$.
