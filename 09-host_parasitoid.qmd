...
``` 
Next we just make a histogram (@fig-PoisSim) of the number of unattacked hosts, adding a dotted line to show where the true data lie, and a dashed line for the prediction, under the assumption of random and independent attacks, based on the Poisson distribution.
...
Our simulation results (@fig-PoisSim) indicate that the observed data include far more unattacked hosts than expected by chance.
