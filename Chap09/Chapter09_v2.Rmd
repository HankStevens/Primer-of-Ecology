---
title: "Coexistence via competition, dispersal, and storage"
author: "MHHS"
date: "`r Sys.Date()`"
output:
  ...
  html_document:
    df_print: paged
bibliography: /Users/stevenmh/tidy.bib
---
...
db <- d %>%
  ...
  select(AGE, Annuals, Perennials, Woody) %>%
...
knitr::include_graphics("PandR.pdf")
```
...
include_graphics("ED1.pdf")
include_graphics("ED2.pdf")
```
