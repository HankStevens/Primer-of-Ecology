...
In the above model, per capita growth rates were linear functions of resource concentration. It is more common to see a type II [functional response](#fr) for the consumers [@tilman1982] (Fig. @fig-monod), which we described in Chapter 8.
