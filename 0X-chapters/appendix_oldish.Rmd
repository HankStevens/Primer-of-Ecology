...
- Making beautiful and informaive graphs with `ggplot2`
...
what this does.
```{r  keep.source=true, results=hide  }
...
```{r MyTrees1, fig=true, echo=false, results=hide }
par(mar=c(5,4,3,2))
plot(Girth, Volume, type='n', main = "My Trees")
points(Girth, Volume, type='h' , col="lightgrey", pch=19)
hts <- (Height-min(Height))/max(Height-min(Height))
