...
\begin{figure}[ht]\label{fig:SPR}
  \centering
  \subfloat[$\gamma=5$]{\includegraphics[width=.48\textwidth]{SNPR1}  \label{fig:SPR1}}
  \subfloat[$\gamma=0.1$]{\includegraphics[width=.48\textwidth]{SNPR2}  \label{fig:SPR2}}\\
  \subfloat[$\gamma=0.1,\,m=0.105$]{\includegraphics[width=.48\textwidth]{SNPR3}  \label{fig:SPR3}}
  \subfloat[$\alpha=1,\,\gamma=0.1$]{ \includegraphics[width=.48\textwidth]{SNPR4}  \label{fig:SPR4}}
...
<<SNPR3, fig=TRUE>>=
params.suc["g"] <- 5; params.suc["m"] <- abs(log(.9))
ccg.out <- data.frame(ode(init.suc, t, succniche, params.suc))
matplot(t, ccg.out[,-1], type="l", ylab="Relative Frequency", xlab="Time",
        ylim=c(0,1), col=1)
@ 
