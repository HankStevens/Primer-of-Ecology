# Direct competition and mutualism {#comp}
```{r include=FALSE}
...
$y=N_2$, $m= -\alpha_{21}/\alpha_{22}$, and $b=1/\alpha_{22}$ (Fig. @fig-Niso1). When $N_1$ is zero, $N_2=1/\alpha_{22}$. This is precisely what we saw in Chapter 3 (logistic growth), that a single species logistic population has an equilibrium at its carrying capacity, $K=1/\alpha$.
