...
c. (i) the number of offspring per individual (or the per capita birth and death rates) are constant through time, and ...
c. ... (ii) independent of the number of individuals in the population.
